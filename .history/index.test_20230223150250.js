...
test('Validating Key inside object', () => {
	expect(functions.objVal({name:"Kayla", Age: 24, Sex:"f"}, 'name')).toBe(True);
});
test('Print true or false', () => {
    expect(typeof functions.objVal({name:"Kayla", Age: 24, Sex:"f"}, 'name')).toStrictEqual('boolean');
})